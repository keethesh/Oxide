...
- Fix sector-aligned NTFS reads so unaligned scan reads stay correct.
- Prevent overlapping scans, scope cancellation to the active run, and make Explorer reveal files instead of opening them.
- Skip reparse-point directories during filesystem fallback and expose skipped/error counters for partial scan visibility.
...
[unreleased]: https://github.com/keethesh/oxide/compare/v0.4.1...HEAD
[0.4.1]: https://github.com/keethesh/oxide/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/keethesh/oxide/compare/v0.3.0...v0.4.0
